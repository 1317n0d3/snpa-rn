      ...
      <View style={styles.container}>
        ...
        >
          ...
          <TouchableHighlight
            ...
            disabled={this.state.isLoading}
          >
            <TabBarIcon name={this.state.isPlaying ? 'pause' : 'play'}/>
          </TouchableHighlight>
          <TouchableHighlight
            underlayColor={BACKGROUND_COLOR}
            style={styles.wrapper}
          ...
          >
            <TabBarIcon name={this.state.loopingType === 1 ? 'random' : 'repeat'}/>
          </TouchableHighlight>
        </View>
      </View>
    );
